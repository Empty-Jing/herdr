...
const PI_QUOTA_EXTENSION_INSTALL_NAME: &str = "herdr-openai-quota.ts";
const PI_QUOTA_EXTENSION_ASSET: &str = include_str!("assets/pi/herdr-openai-quota.ts");
const PI_QUOTA_INTEGRATION_VERSION: u32 = 1;
...
const OPENCODE_QUOTA_PLUGIN_INSTALL_NAME: &str = "herdr-openai-quota.js";
const OPENCODE_QUOTA_PLUGIN_ASSET: &str = include_str!("assets/opencode/herdr-openai-quota.js");
const OPENCODE_QUOTA_INTEGRATION_VERSION: u32 = 1;
